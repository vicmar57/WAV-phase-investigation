...
for data_block1, data_block2 in zip(data1,data2):
    ...
    #switch phases
    switched1 = cartes(r1,theta1) #part1 amplitude, with phase of part2  np.linspace(0,math.pi*2.0,52001)
    switched2 = cartes(r2,theta2) #part2 amplitude, with phase of part1
...
wavfile.write("part1afterloop.wav",samplerate, finalIFFT1)
wavfile.write("part2afterloop.wav",samplerate, finalIFFT2)
